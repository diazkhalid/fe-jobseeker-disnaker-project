        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
          <div className="space-y-2 text-center sm:text-left">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Temukan <span className="text-teal-700">Karier Impian</span> Anda
              di Sumbawa
            </h1>
              ...
              <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
                ...
                <div className="relative w-full sm:w-auto">
                  <select
                    ...
                    className="w-full sm:w-auto appearance-none bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 pr-9 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all cursor-pointer"
                  >
            ...
            {filteredJobs.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredJobs.map((job) => (
                  <div
                    key={job.id}
                    className="bg-white rounded-3xl border border-slate-100 p-6 flex flex-col gap-5 shadow-sm hover:shadow-lg hover:border-teal-100 hover:shadow-teal-700/5 transition-all duration-300 relative group"
                  >
                    {job.isFeatured && (
                    ...
                    <div className="flex items-start gap-4 border-b border-slate-100 pb-5">
                      ...
                      <div className="space-y-1 flex-1 pr-8">
                        <Link
                          ...
                          className="block"
                        >
                          <h3 className="text-base font-extrabold text-slate-900 group-hover:text-teal-700 transition-colors line-clamp-2 leading-snug">
                            {job.title}
                          </h3>
                        </Link>
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-teal-50 text-teal-700 text-[10px] font-bold border border-teal-100">
                    ...
                    <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-3 text-[10px] text-slate-400">
                      ...
                      <Link
                        href={`/lowongan-kerja/${job.id}`}
                        className="inline-flex items-center gap-1.5 text-xs font-bold text-teal-700 hover:text-teal-800 transition-colors shrink-0"
                      >
                        Detail
            ...
            {filteredJobs.length > 0 && (
              <div className="pt-8 border-t border-slate-100 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-1 text-xs font-semibold text-slate-700">
                  <button className="w-9 h-9 rounded-lg bg-teal-700 text-white shadow-md shadow-teal-700/10 flex items-center justify-center">
                    1
                  </button>
                </div>
